...
# Honour MOLMO_BASE_URL for load-balancing across multiple Molmo VLM
# instances; default to the canonical local vllm server on :8122.
SERVICE_URL = os.environ.get("MOLMO_BASE_URL", "http://127.0.0.1:8122/v1")
