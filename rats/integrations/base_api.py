...
class ApiBase(ABC):
    ...
    def _log_step(
        ...
        This is a thin wrapper around :func:`rats.utils.execution_logger.log_step`
    ...
    def _log_step_update(
        ...
        if not self._webui_enabled:
            return
        from rats.utils.execution_logger import log_step_update
