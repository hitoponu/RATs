...
Usage::
    ...
    uv run --no-sync --active rats/envs/launch.py \\
...
Execution flow::
    ...
    main()
      ...
      └─ _run_headless_trials()   (CLI batch mode)  [in rats.envs.runner]
           ├─ _run_trial_batch()  (sequential)
           └─ run_parallel_*()    (multi-worker)
                └─ _run_single_trial()  [in rats.envs.trial]
"""
...
def main(args: LaunchArgs) -> None:
    ...
    from rats.envs.runner import _run_headless_trials, _start_api_servers, _stop_api_servers
