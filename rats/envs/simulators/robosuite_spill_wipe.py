...
from rats.envs.simulators.robosuite_base import RobosuiteBaseEnv
...
class FrankaRobosuiteSpillWipeLowLevel(RobosuiteBaseEnv):
    ...
    def __init__(
        self,
        controller_cfg: str = "rats/integrations/robosuite/controllers/config/robots/panda_joint_ctrl.json",
        max_steps: int = 4000,
        seed: int | None = None,
